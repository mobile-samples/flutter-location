...
import 'package:flutter_user/services/Film.dart';
import 'package:webview_flutter/webview_flutter.dart';
import 'package:flutter_user/widgets/reviews/tab_reviews.dart';
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
                ...
                children: [
                  ClipPath(
                    ...
                    child: Container(
                      ...
                      height: 300,
                      child: Image(
                        image: NetworkImage('https://aestheticmedicalpractitioner.com.au/wp-content/uploads/2021/06/no-image.jpg',),
                        fit: BoxFit.cover,
                        height: 220,
              ...
              Divider(),
              if (film.description!.length > 0) SubDescTitle( title: 'Overview',content: film.description ?? ''),
              if (film.casts!.length > 0) SubDescTitle( title: 'Casting',content:  (film.casts ?? []).join(",").toString(),),
              if (film.directors!.length > 0) SubDescTitle( title: 'Director',content: (film.directors ?? []).join(",").toString(),),
              if (film.productions!.length > 0) SubDescTitle( title: 'Productions',content:  (film.productions ?? []).join(",").toString(),),
              SizedBox(
